...
from app.seismic.alert_router import router as seismic_alert_router
from app.seismic.alerts import ensure_alert_schema
...
app.include_router(seismic_alert_router)
